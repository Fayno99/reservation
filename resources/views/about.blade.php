    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">Зв'язатися з нами</h1>
                <a href="" class="h5 text-white">Домашня</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h5 text-white">Про нас</a>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            <h5 class="fw-bold text-primary text-uppercase">Зв'язатися з нами</h5>
            <h1 class="mb-0">Якщо у вас є запитання, зв’яжіться з нами</h1>
        </div>
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <div class="ps-4">
                        <h5 class="mb-2">Телефонуйте, щоб задати будь-яке питання</h5>
