            ...
            <div class="row gx-0">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <input type="text" class="form-control border-0 bg-light px-4"
                                               placeholder="Назва роботи" name="name_of_work" style="height: 55px;">
                                    </div>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control border-0 bg-light px-4"
                                               placeholder="Пояснення" name="description" style="height: 55px;">
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control border-0 bg-light px-4"
                                               placeholder="Ціна" name="price" style="height: 55px;">
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control border-0 bg-light px-4"
                                               placeholder="Час для роботи" name="time_for_work" style="height: 55px;">
                                    </div>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th class="h1 text-white"> Active</th>
